...
class ProductoController extends Controller {
	...
	public function accessRules() {
		...
		'actions' => array('create', 'update', 'imagenes', 'imagenes', 'loadImage', 'loadImageCenter', 'descarga', 'eliminar', 'asociarproducto', 'ajaxupdate', 'listaproducto', 'imagenprincipal','catalogo'), 'users' => array('@'), ), array('allow', // allow admin user to perform 'admin' and 'delete' actions

		'actions' => array('catalogo','create', 'update', 'imagenes', 'imagenes', 'loadImage', 'loadImageCenter', 'descarga', 'eliminar', 'asociarproducto', 'ajaxupdate', 'listaproducto'), 'users' => array('@'), ), array('allow', // allow admin user to perform 'admin' and 'delete' actions
