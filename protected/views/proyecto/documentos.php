...
$pag="doc";
$this->pageTitle="Proyecto Documentos - ".$proyecto->nombre;
...
<div>
	...
	<?php foreach($proyecto->documentos as $documento){
		echo CHtml::link($documento->fileName,array('descarga','id'=>$documento->id))."&nbsp &nbsp &nbsp &nbsp &nbsp&nbsp &nbsp &nbsp".CHtml::link("eliminar",array('eliminar','id'=>$documento->id,'pag'=>$pag),array('style' => 'color:red'))."<br/>"; 
	}	
	?>
</div>